...
/*   Updated: 2024/07/16 15:21:07 by norban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_string(char *str, char *charset, int j)
{
	...
	i = 0;
	while (i git@vogsphere-v2.s19.be:vogsphere/intra-uuid-dfac00be-3f4b-4448-837d-6194fb457dca-5813917-norban< k)
	{
		s1[i] = str[j];
		i++;
		j++;
...
int	get_strc(char *str, char *charset)
{
	...
	if (is_char_sep(str[0], charset) > 0 && is_char_sep(str[0], charset) > 0)
		strc++;git@vogsphere-v2.s19.be:vogsphere/intra-uuid-dfac00be-3f4b-4448-837d-6194fb457dca-5813917-norban
	return (strc);
}
