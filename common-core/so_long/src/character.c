...
/*   Updated: 2025/01/17 19:26:00 by norban           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_mc2(t_game *game, int keycode)
{
	...
	{
		game->sprites[1]->coord->x += 10; //right
	...
	{
		game->sprites[1]->coord->x -= 10; //left
...
void	move_mc(t_game *game, int keycode)
{
	...
	{
		game->sprites[1]->coord->y += 10; //down
