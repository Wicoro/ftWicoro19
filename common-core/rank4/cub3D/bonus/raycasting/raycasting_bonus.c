...
/*   Updated: 2025/07/22 18:07:19 by stdevis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	raycasting(t_data *data)
{
	...
	ft_memset(data->img[2].addr, 0, data->minimap.minimap_h
		* data->minimap.minimap_w * 4);
	minimap(data);
	step = FOV / WIDTH;
